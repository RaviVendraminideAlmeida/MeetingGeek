package br.com.meetinggeek.security.jwt;
...
public class JwtUtils {
    ...
    @Value("${meetinggeek.app.jwtSecret}")
    private String jwtSecret;

    @Value("${meetinggeek.app.jwtExpirationMs}")
    ...
    public String generateJwtToken(Authentication authentication){
        ...
        return Jwts.builder().setSubject((userPrincipal.getApelido())).setIssuedAt(new Date())
    ...
    public boolean validateJwtToken(String authToken) {
        try {
            ...
            logger.error("Token JWT enválido: {}", e.getMessage());
